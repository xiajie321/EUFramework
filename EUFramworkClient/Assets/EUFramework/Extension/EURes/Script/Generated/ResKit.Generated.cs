    ...
    public static partial class ResKit
    {
        ...
        public static ResourcePackage GetPackage(string packageName = null)
        {
            ...
            if (string.IsNullOrEmpty(packageName))
            {
                ...
                {
                    Debug.LogError($"[ResKit] Default package is not set!");
                    return null;
                }
