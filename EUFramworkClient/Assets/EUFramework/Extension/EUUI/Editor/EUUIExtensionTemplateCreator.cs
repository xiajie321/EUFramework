...
namespace EUFramework.Extension.EUUI.Editor
{
    ...
    public class EUUIExtensionTemplateCreator : EditorWindow
    {
        ...
        {
            ResourceLoader,    // 资源加载器（EUUIKit）
            PanelExtension,    // 面板扩展（EUUIPanelBase）
            KitExtension       // UIKit 功能扩展
        }
        ...
        private ExtensionType extensionType = ExtensionType.ResourceLoader;
        ...
        private void OnGUI()
        {
            ...
            {
                ExtensionType.ResourceLoader => "创建自定义资源加载系统（如 Addressables、AssetBundle）",
                ExtensionType.PanelExtension => "为 EUUIPanelBase 添加静态扩展方法（如 OSA、DoTween）",
                ExtensionType.KitExtension => "为 EUUIKit 添加功能扩展（如分析统计、日志）",
                _ => ""
            };
            ...
            string presetHint = templatePreset switch
            {
                ...
                TemplatePreset.Utility => "包含独立功能方法示例",
                _ => ""
            };
        ...
        public static string GenerateTemplateContent(ExtensionType extensionType, TemplatePreset templatePreset, string extensionName)
        {
            string content = templatePreset switch
            {
                ...
                TemplatePreset.Utility => GetUtilityTemplate(extensionType),
...
";
        ...
        private static string GetUtilityTemplate(ExtensionType extensionType)
        {
            if (extensionType == ExtensionType.PanelExtension)
            {
                return @"//------------------------------------------------------------------------------
...
namespace EUFramework.Extension.EUUI
{
    ...
    public static class EUUIPanelBase{{extension_name}}Extensions
    {
        ...
        /// TODO: 查找子组件工具方法
        /// </summary>
        public static T Find{{extension_name}}Component<T>(this EUUIPanelBase panel, string path) where T : Component
        {
            // TODO: 实现组件查找逻辑
            Transform trans = panel.transform.Find(path);
        ...
        /// TODO: 批量设置工具方法
        /// </summary>
        public static void SetInteractable<T>(this EUUIPanelBase<T> panel, bool interactable)
            where T : EUUIPanelBase<T>, new()
        {
            // TODO: 实现批量设置逻辑
...
namespace EUFramework.Extension.EUUI
{
    ...
    public static partial class EUUIKit
    {
        ...
        /// TODO: 获取所有打开的面板列表
        /// </summary>
        public static List<string> {{extension_name}}_GetOpenPanelNames()
        {
            // TODO: 实现获取逻辑
            return new List<string>(_activePanels.Keys);
        }
        
        /// <summary>
        /// TODO: 检查面板是否打开
        /// </summary>
        public static bool {{extension_name}}_IsPanelOpen(string panelName)
        {
            // TODO: 实现检查逻辑
            return _activePanels.ContainsKey(panelName);
        }
        
        /// <summary>
        /// TODO: 获取面板实例
        /// </summary>
        public static IEUUIPanel {{extension_name}}_GetPanelInstance(string panelName)
        {
            // TODO: 实现获取逻辑
